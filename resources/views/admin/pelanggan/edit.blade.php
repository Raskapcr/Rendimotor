        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('pelanggan.update') }}">Pelanggan</a></li>
                ...
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="last_name" name="last_name" type="text"
                            placeholder="Also your last name" value="{{ $dataPelanggan->last_name }}">
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input data-datepicker="" class="form-control" id="birthday" name="birthday" type="date"
                            placeholder="yyyy/mm/dd" value="{{ $dataPelanggan->birthday }}">
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="email" name="email" type="email"
                            placeholder="name@company.com" value="{{ $dataPelanggan->email }}">
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="phone" name="phone" type="number"
                            placeholder="+12-345 678 910" value="{{ $dataPelanggan->phone }}">
                    </div>
                </div>
            </div>
