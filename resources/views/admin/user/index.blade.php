...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route('user.create') }}" class="btn btn-sm btn-success text-white d-inline-flex align-items-center">
                    ...
                    <tbody>
                        ...
                        @foreach ($dataUser as $row)
                            <tr>
                                ...
                                <td style="text-align: center;"> <img src="{{ $row->photo }}" alt=""
                                ...
                                <td>
                                    <span
                                        class="badge {{
                                            $row->role == 'Administrator' ? 'bg-success' :
                                            ($row->role == 'Pelanggan' ? 'bg-warning' : '')
                                        }}">
                                        {{ $row->role }}
                                    </span>
                                </td>
                                <td> <a href="{{ route('user.edit', $row->id) }}" class="btn btn-info btn-sm">
