...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <p class="mb-0">Form perubahan data product</p>
        </div>
                ...
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="nama_produk" name="nama_produk" type="text"
                            placeholder="Enter your Nama Produk" value="{{ $dataProduct->nama_produk }}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="foto" name="foto" type="file"
                                placeholder="Enter your foto" value="{{ $dataProduct->foto }}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="harga" name="harga" type="text"
                            placeholder="Enter your harga" value="{{ $dataProduct->harga }}">
                    </div>
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="stok" name="stok" type="number"
                            placeholder="Enter your stok" value="{{ $dataProduct->stok }}">
                    </div>
                </div>
            </div>
            <div class="form-check">
                <input type="checkbox" class="form-check-input" id="is_best_seller" name="is_best_seller"
                       {{ $dataProduct->is_best_seller ? 'checked' : '' }}>
