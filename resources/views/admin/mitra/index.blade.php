...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <p class="mb-0">List Seluruh Data Mitra</p>
        </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($dataMitra as $row)
                            <tr>
                                ...
                                <td><span
                                        class="badge
                                        {{ $row->jenis_kemitraan == 'Platinum'
                                            ? 'bg-success'
                                            : ($row->jenis_kemitraan == 'Gold'
                                                ? 'bg-warning'
                                                : ($row->jenis_kemitraan == 'Silver'
                                                    ? 'bg-danger'
                                                    : '')) }}">
                                        {{ $row->jenis_kemitraan }}
                                </span></td>
                                <td> {{ $row->tgl_bergabung }}</td>
                                <td><a href="{{ route('mitra.edit', $row->mitra_id) }}" class="btn btn-info btn-sm">
