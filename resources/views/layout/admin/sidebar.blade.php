    ...
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
                ...
                <a href="../../index.html" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon">
                        <img src="{{ asset('assets/img/logo.webp') }}"
                            style="max-height: 130px; width: 130px; border-radius: 50%; object-fit: cover;"
                            alt="Volt Logo">
                    </span>
                </a>
            </li>
            ...
            <li class="nav-item {{ request()->is('pelanggan*') ? 'active' : '' }}">
                <a href="{{ route('pelanggan.list') }}" class="nav-link d-flex align-items-center gap-2">
                    <span class="sidebar-icon">
            ...
            <li class="nav-item {{ request()->is('product*') ? 'active' : '' }}">
                <a href="{{ route('product.list') }}" class="nav-link d-flex align-items-center gap-2">
                    <span class="sidebar-icon">
            ...
            <li class="nav-item {{ request()->is('user*') ? 'active' : '' }}">
                <a href="{{ route('user.list') }}" class="nav-link d-flex align-items-center gap-2">
                    <span class="sidebar-icon">
