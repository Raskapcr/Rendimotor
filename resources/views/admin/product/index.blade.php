...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Data Product</h2>
            <p class="mb-0">List Seluruh Data Product</p>

        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route('product.create') }}" class="btn btn-sm btn-success text-white d-inline-flex align-items-center">
                    ...
                    <tbody>
                        ...
                        @foreach ($dataProduk as $row)
                            <tr>
                                ...
                                <td style="text-align: center;"> <img src="{{ $row->foto }}" alt=""
                                    width="50px" height="50px" style="border-radius: 50%;"> </td>
                                <td>{{ "Rp " . number_format($row->harga, 0, ',', '.') }}</td>
                                <td>{{ $row->stok }}</td>
                                <td> <a href="{{ route('product.edit', $row->product_id) }}" class="btn btn-info btn-sm">
                                    ...
                                    <a href="{{ route('product.destroy', $row->product_id) }}" class="btn btn-danger btn-sm">
                                        <svg class="icon icon-xs me-2" data-slot="icon" fill="none" stroke-width="1.5"
                                            stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                            aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round"
